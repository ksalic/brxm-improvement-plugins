        ...
        if (mode == Mode.COMPARE) {
            if (config.containsKey("model.compareTo")) {
                ...
                if (baseRef != null) {
                    ...
                    baseModel = new JcrNodeModel(baseDocument.getItemModel().getPath() + "/" + RelatedDocsNodeType.NT_RELATEDDOCS);
                } else {
    ...
    private RefreshingView<RelatedDoc> createRefreshingView(final RelatedDocCollection relatedDocCollection) {
        ...
        return new RefreshingView<RelatedDoc>("view") {
            ...
            protected void populateItem(Item item) {
                List<RelatedDoc> relatedDocs = IteratorUtils.toList(relatedDocCollection.iterator());
